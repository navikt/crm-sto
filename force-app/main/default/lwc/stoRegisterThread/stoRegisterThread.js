...
import ENDRING_INTERNASJONAL_INGRESS from '@salesforce/label/c.Beskjed_til_oss_Endring_Internasjonal_ingress';
import ENDRING_YRKESSKADE_INGRESS from '@salesforce/label/c.Beskjed_til_oss_Endring_Yrkesskade_ingress';
...
export default class StoRegisterThread extends NavigationMixin(LightningElement) {
    ...
    btoCategoryAndThemeMap = {
        ...
        endring: {
            ...
            yrkesskade: { category: 'Helse', theme: 'Yrkesskade' }
        },
        // Trekke en søknad
        'trekke-soknad': {
    ...
    ingressMap = {
        ...
        'Meld fra om endring': {
            ...
            'Bor eller jobber i utlandet': ENDRING_INTERNASJONAL_INGRESS,
            Yrkesskade: ENDRING_YRKESSKADE_INGRESS
        },
        'Trekke en søknad': {
